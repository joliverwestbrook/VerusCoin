...
CXXFLAGS='-arch x86_64 -I/usr/local/Cellar/gcc@7/7.4.0/include/c++/7.4.0/ -I$PREFIX/include -fwrapv -fno-strict-aliasing -Werror -g -Wl,-undefined -Wl,dynamic_lookup' \
